...
describe('functions', () => {
    ...
    describe('parameters to functions', () => {
        ...
        describe('higher order functions', () => {
            it('an example of a fucntion that takes a function', () => {
    ...
    describe('array methods', () => {
        ...
        // JS has a for while loops, do loops, for loop (e.g. for (let x =0; x<100; x++) {}); and others.. I am showing something else.
        it('visting each element in an array', () => {
        ...
        describe('methods that create a new array', () => {
            it('map', () => {
                ...
                expect(doubled).toEqual([2, 4, 6, 8, 10, 12, 14, 16, 18]); // this will fail in really dumb way

            });
            it('filter', () => {
                // const evens = numbers.filter(n => isEven % 2 === 0);
        ...
        describe('methods that return a single value', () => {
            describe('checking the membership', () => {
                it('seeing if all the members meet the criteria', () => {
                ...
                it('has reduce', () => {
                    ...
                    const total2 = numbers.reduce(accumulate);
                    expect(total2).toBe(145);

                    const totofDoubledEvens = numbers
                        .filter(isEven)
                        .map(doubleIt)
                        .reduce((s, n) => s + n);

                    expect(totofDoubledEvens).toBe(40);
                });
